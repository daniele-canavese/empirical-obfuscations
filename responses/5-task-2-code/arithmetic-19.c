...
int problem(void)
{
	...
	while (1) {
		...
		break;
	    case 125:
		encoder(8, encodeStrings_litStr8);  //n = 8 => WRONG
		{
		    _6_problem_next =
			(unsigned
			 long) (_5_problem__opaque_array[((unsigned
		...
		//printf("Case 35 -> problem_next = %lu\n", _6_problem_next); // == 34
		break;
	    case 34:;
	    int n;
	    if(tmp___2) n=1; else n=0;
	    printf("if: %d\n", n);

		if (tmp___2) {  // tmp___2 : valore inserito
		    {
			_6_problem_next =
			    (unsigned
			     long) (_5_problem__opaque_array[((unsigned
		...
		printf("Case 34, tmp_2 == %s, problem_next = %lu\n", tmp___2, _6_problem_next); // == 33 (o 166?)
		break;
	    case 33:
		_3_problem_next = 2;
		{
		...
		break;
	    case 10:
		encoder(7, encodeStrings_litStr7); // n==7 => RIGHT
		{
		    _6_problem_next =
			(unsigned
			 long) (_5_problem__opaque_array[((unsigned
		...
		break;
	    case 227:;
	    // chiamato solo se risultato errato
		if (op == 43) { // +
		    {
			_6_problem_next =
			    (unsigned
