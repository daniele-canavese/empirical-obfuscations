...
char check(void)
{
    ...
    {
        {
            _6_check_next =(unsigned long) (_5_check__opaque_array[((unsigned int) (i -((i +i) & (i>>31)))% 10) * 3 +0] %_5_check__opaque_array[5] + 110);
        }
        while (1)
        {
            ...
            case 110:
                tmp = (char) 'X';
                {
                    _6_check_next =(unsigned long) (_5_check__opaque_array[((unsigned int) ((i ^(i >> 31))-(i >> 31)) %10) * 3 +1] %_5_check__opaque_array[11] + 103);
                }
                break;
            case 109:
                ;
                ...
                case 18:
                {
                    _6_check_next =(unsigned long) (_5_check__opaque_array[((unsigned int) (((_4entropy | 7) + ((_4entropy | 7) >> 63L)) ^ ((_4entropy | 7) >> 63L)) % 10) * 3 + 1] % _5_check__opaque_array[11] + 105);
                }
                break;
                case 28:
                {
            ...
            case 107:
                matrix[i][0] = tmp;
                {
                    _6_check_next =(unsigned long) (_5_check__opaque_array[((unsigned int) ((i +(i >> 31))^ (i >> 31))% 10) * 3 +0] %_5_check__opaque_array[5] + 102);
                }
                break;
            case 105:
                _3_check_next = 17;
            ...
            case 113:
                _3_check_next = 25;
                {
                    _6_check_next =(unsigned long) (_5_check__opaque_array[((unsigned int) ((_4entropy ^ 10) - (((_4entropy ^ 10) + (_4entropy^ 10)) &((_4entropy^ 10) >>63L))) %10) * 3 +0] %_5_check__opaque_array[5] + 106);
                }
                break;
            }
        }
