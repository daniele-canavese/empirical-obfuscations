...
char check(void)
{
	...
	while (1) {
	    ...
	    case 27:
            tmp = matrix[i][0]; //MODIFICATO Orizzontale (Invertito)
		{
		    _3_check_next = 17;
		}
		break;
	    case 26:
	        tmp___0 = matrix[0][i]; //MODIFICATO Verticale (inverito)
		{
		    _3_check_next = 7;
		}
		break;
		...
		break;
	    case 30:
		//matrix[0][2] = (char) 'O'; MODIFICATO Diagonale Invertita (Eliminato)
		{
		    _3_check_next = 29;
		}
		break;
		...
		break;
	    case 8:
		//tmp___0 = (char) 'O'; MODIFICATO verticale(Eliminato)
		{
		    _3_check_next = 26;
		}
		break;
		...
		break;
	    case 2:
		//matrix[0][0] = (char) 'O'; MODIFICATO Diagonale (Eliminato)
		{
		    _3_check_next = 1;
		}
		break;
		...
		break;
	    case 18:
		//tmp = (char) 'O'; MODIFICATO Orizzontale (Eliminato)
		{
		    _3_check_next = 27;
		}
		break;
