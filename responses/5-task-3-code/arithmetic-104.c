...
int problem(void)
{
	...
	while (1) {
		...
		break;
	    case 55:;
		if ((unsigned int) tmp___3 == ((unsigned int) result)) {      //levando 4039822362U funziona
		    {                                                                       //result è il risultato corretto
			_3_problem_next = 54;                                                   //tmp___3 è il risultato preso da tastiera
		    }
		} else {
		    {
			_3_problem_next = 51;
