...
int number(char const *p, int len)
{
	...
	while (1) {
		...
		printf((char const *) (encodeStrings_litStr70),
		       ...
		       //printf("Guardo cosa c'e dentro name1: %s", name1[(int const) *p - 48]);
		{
		    _6_number_next =
			(unsigned
			 long) (_5_number__opaque_array[((unsigned
		...
		printf((char const *) (encodeStrings_litStr75),
		       name1[(int const) *p - 48]);
        //int fede;
        //printf("\n %s %s %s \n", name1[(int const) *p - 46], name1[(int const) *p - 47], name1[(int const) *p - 48]);
        //printf("\n %d %s \n", (int const) *p, name1[(int const) *p - 48]);
		{
		    _6_number_next =
			(unsigned
			 long) (_5_number__opaque_array[((unsigned
