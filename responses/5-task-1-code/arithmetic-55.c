...
int problem(void)
{
	...
	while (1) {
	    ...
	    tmp___3 = atoi((char const *) p); //converte il mio input in numero
	    /*int k = (unsigned int) tmp___3 ==((unsigned int) result & 4039822362U);
	    if (k) {*/
        if((unsigned int) tmp___3 == (unsigned int )result){
