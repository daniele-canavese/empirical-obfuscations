...
// Taking the correct char in each
// while loop.
// I get the the char after
// the first check.
// I instantiated a char variable getChar.
char check(void)
{
    int i;
    char tmp;
...
int main(int _formal_argc, char **_formal_argv, char **_formal_envp)
{
...

    {
        ...
        if ((int) done == 88) {
            ...
            printf((char const *) (encodeStrings_litStr9)); // String output problem
        } else {
            encoder(10, encodeStrings_litStr10);
            printf((char const *) (encodeStrings_litStr10)); // String output problem
        }
        disp_matrix();
        return (0);
    }
